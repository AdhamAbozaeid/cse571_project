...
class PID(object):
	...
	def linear_vel(self, dt=None):
		...
		self.i_error_x = (self.p_error_last_x - self.p_error_x) * dt
		
		self.p_error_last_x = self.p_error_x
		
		return (self.KP * self.max_vel * self.p_error_x) + (self.KD * self.max_vel * self.d_error_x) + (self.KI * self.max_vel * self.i_error_x)
	...
	def angular_vel(self, dt=None):
		...
		if self.mode=='linear':
			...
			self.p_error_angular_z_linear_last = self.p_error_angular_z_linear
			return ((self.max_rot *self.KP_rot * self.p_error_angular_z_linear) + (self.max_rot*self.KD_rot*self.d_error_angular_z_linear)+(self.max_rot*self.KI_rot*self.i_error_angular_z_linear))
			...
			return (self.max_rot_angular * self.KP_rot_angular * self.p_error_angular_z_rot) + (self.KD_rot_angular * self.max_rot_angular * self.d_error_angular_z_rot)+(self.KI_rot_angular * self.max_rot_angular * self.i_error_angular_z_rot) 
